...
<script type="text/javascript">
    ...
    function validateForm() {
        ...
        if(x['employer-password'].value==null || x['employer-password'].value=="")
        {
...
<div class="admin-container">
    ...
    <div class="admin-content">
        ...
        <div class="admin-inner-content inner-content-bg" id="admin-inner-content">
            <form name="employer-form" onsubmit="return validateForm()" action="<?php echo base_url(); ?>admin/insertEMP" method="post" enctype="multipart/form-data">
                <h1 style="text-align: center;">Insert Employer Baru</h1>
                <hr/>
                <table>
                    <tr>
                        <input type="hidden" id="employer-id" name="employer-id" value="<?php echo $id_employer; ?>"/>
                        <td>Nama Perusahaan</td>
                        <td><input type="text" id="employer-nama" name="employer-nama" placeholder="input nama perusahaan"/></td>
                    </tr>
                    <tr>
                        <td>Email Perusahaan</td>
                        <td><input type="text" id="employer-email" name="employer-email" placeholder="input email perusahaan"/></td>
                    </tr>
                    <tr>
                        <td>Password</td>
                        <td><input type="password" id="employer-password" name="employer-password"/></td>
                    </tr>
                    <tr>
                        <td>NPWP</td>
                        <td>
                            <input type="text" id="employer-npwp" name="employer-npwp" placeholder="Input NPWP"/>
                        </td>
                    </tr>
                    <tr>
                        <td>Alamat</td>
                        <td>
                            <textarea cols="20" rows="5" id="employer-alamat" name="employer-alamat"></textarea>
                        </td>
                    </tr>
                    <!--<tr>
                        <td>Kota</td>
...
/*                                endforeach;
                    ...
                    <tr>
                        <td>No Telepon</td>
                        <td>
                            <input type="text" id="employer-telepon" name="employer-telepon" placeholder="Input Nomor Telepon" />
                        </td>
                    </tr>
                    <tr>
                        <td>Tipe</td>
                    ...
                    <tr>
                        <td>Logo</td>
                        <td>
                            <input type="file" id="employer-logo" name="employer-logo"/>
                        </td>
                    </tr>
                    <tr>
