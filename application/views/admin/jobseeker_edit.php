...
<script type="text/javascript">
    ...
    function validateForm() {
        ...
        if($('#jobseeker-password').prop('disabled')===false && (x['jobseeker-password'].value==null || x['jobseeker-password'].value==""))
        {
        ...
        if(x['jobseeker-kota-1'].value=="---" || x['jobseeker-kota-2'].value=="---")
        {
...
<div class="admin-container">
    ...
    <div class="admin-content">
        ...
        <div class="admin-inner-content inner-content-bg" id="admin-inner-content">
            <form name="jobseeker-form" onsubmit="return validateForm()" action="<?php echo base_url(); ?>admin/editJs" method="post">
                <h1 style="text-align: center;">Edit Jobseeker</h1>
                <hr/>
                <?php
                foreach($jobseeker as $js):
                    ...
                    $gender = $js->gender;
                    $kota = $js->kota;
                    $kotabaru = explode(',',$kota);
                    if($id==$edit_id)
                    {
                ?>
                <table>
                    <tr>
                        <input type="hidden" id="jobseeker-id" name="jobseeker-id" value="<?php echo $edit_id; ?>"/>
                        <td>Nama</td>
                        <td><input type="text" id="jobseeker-nama" name="jobseeker-nama" placeholder="input nama" value="<?php echo $js->nama; ?>"/></td>
                    </tr>
                    <tr>
                        <td>Email</td>
                        <td><input type="text" id="jobseeker-email" name="jobseeker-email" placeholder="input email" value="<?php echo $js->email; ?>"/></td>
                    </tr>
                    <tr>
                        <td>Password</td>
                        <td>
                            <input type="button" id="jobseeker-pass-ok" name="jobseeker-pass-ok" value="Ubah Password?" />
                            <input type="password" id="jobseeker-password" name="jobseeker-password" disabled/></td>
                    </tr>
                    <tr>
                        <td>Gender</td>
                        <td>
                            <input type="radio" name="jobseeker-gender" value="pria" <?php if($gender=="pria"){ echo "checked"; } ?> />Pria
                            <input type="radio" name="jobseeker-gender" id="jobseeker-gender" value="wanita" <?php if($gender=="wanita"){ echo "checked"; } ?> />Wanita
                        </td>
                    </tr>
                    <tr>
                        <td>Tanggal Lahir</td>
                        <td><input type="date" id="jobseeker-tgllahir" name="jobseeker-tgllahir"  value="<?php echo $js->tanggal_lahir; ?>"/></td>
                    </tr>
                    <tr>
                        <td>No Telepon</td>
                        <td><input type="text" id="jobseeker-telepon" name="jobseeker-telepon" placeholder="input telepon"  value="<?php echo $js->no_telepon; ?>"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Minat Kerja</td>
                        <td>
                            <textarea cols="20" rows="5" id="jobseeker-minat" name="jobseeker-minat"><?php echo $js->minat_kerja; ?></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td>Lama Pengalaman</td>
                        <td><input type="text" id="jobseeker-pengalaman" name="jobseeker-pengalaman" placeholder="input lama pengalaman kerja"  value="<?php echo $js->lama_pengalaman; ?>"/></td>
                    </tr>
                    <tr>
                        <td>Gaji</td>
                        <td><input type="text" id="jobseeker-gaji" name="jobseeker-gaji" placeholder="input gaji yang diinginkan"  value="<?php echo $js->gaji; ?>"/> </td>
                    </tr>
                    <tr>
                        <td>Alamat</td>
                        <td>
                            <textarea cols="20" rows="5" id="jobseeker-alamat" name="jobseeker-alamat"><?php echo $js->alamat; ?></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td>Kota</td>
                    ...
                    <tr>
                        <td>Status Profil</td>
                        <td>
                            <select id="jobseeker-statusprofil" name="jobseeker-statusprofil">
                                <option>no</option>
                                <option>yes</option>
                            </select>
                        </td>
                    ...
                    <tr>
                        <td>Status Pendidikan dan Pengalaman Kerja</td>
                        <td>
                            <select id="jobseeker-statusexpnedu" name="jobseeker-statusexpnedu">
                                <option>no</option>
                                <option>yes</option>
                            </select>
                        </td>
                    ...
                    <tr>
                        <td>Status CV</td>
                        <td>
                            <select id="jobseeker-statuscv" name="jobseeker-statuscv">
                                <option>no</option>
                                <option>yes</option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="jobseeker-statusjobalert" name="jobseeker-statusjobalert">
                                <option>no</option>
                                <option>yes</option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <script type="text/javascript">
                            $('#jobseeker-pendidikan').val('<?php echo $js->pendidikan_terakhir; ?>');
                            $('#jobseeker-kota-1').val('<?php echo $kotabaru[0]; ?>');
                            $(document).ready(function(){
                                $('#jobseeker-pass-ok').click(function(){
                                    $('#jobseeker-password').prop('disabled',false);
                                    $(this).remove();
                                });
                                $('#jobseeker-kota-1').trigger('change');
                                setTimeout(function(){$('#jobseeker-kota-2').val('<?php echo $kotabaru[1]; ?>')},200);
                            });
                            $('#jobseeker-agama').val('<?php echo $js->agama; ?>');
                            $('#jobseeker-statusprofil').val('<?php echo $js->status_profil; ?>');
                            $('#jobseeker-statusexpnedu').val('<?php echo $js->status_expnedu; ?>');
                            $('#jobseeker-statuscv').val('<?php echo $js->status_cv; ?>');
                            $('#jobseeker-statusjobalert').val('<?php echo $js->status_jobalert; ?>');
                        </script>
                <?php
                    }
                endforeach;
