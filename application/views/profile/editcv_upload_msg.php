...
<div id="container" style="z-index:10;">
    <div class="editprofile_success">
        <div class="editprofile-s-title"><?php echo $errortitle; ?></div>
        <hr/>
        <div><?php echo $error; ?></div><br/>
        Klik <b><a href="<?php echo $referer; ?>">disini</a></b> untuk balik ke page sebelumnya atau tunggu 5 detik untuk redirect
    </div>
    <script>
